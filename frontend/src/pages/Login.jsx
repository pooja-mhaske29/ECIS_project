      ...
      >
        ...
        >
          <div className="text-center">
            ...
            <p className="text-gray-400">Environmental Crime Intelligence System</p>
          </div>
          ...
          <div className="text-center text-sm text-gray-400">
            ...
            <Link to="/register" className="text-neon-green hover:text-neon-cyan transition-colors">
              Create one
            </Link>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="mt-6 p-4 glass-dark text-xs text-gray-400 space-y-1"
        >
          <p className="text-neon-green font-semibold">Demo Credentials:</p>
